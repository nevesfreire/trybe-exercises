...
// Crie uma função sum que dado um número variável de elementos retorna a soma desses 
// elementos. 

// escreva sum abaixo
const sum = (...numbers) => {let total = 0; for (i in numbers) {total+=numbers[i]}; return total;}
...
// const assert = require('assert')
function swap (myList) {const [a,b,c] = myList; return [c,b,a];}
